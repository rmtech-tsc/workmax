 ...
 */
 ...
 import {
   ...
   toggleBlockAdminInDB,
   toggleBlockEmployeeInDB,
   ...
   users: [
     {
       ...
       role: 'global_admin',
       name: 'RM Tech',
       email: 'globaladmin@workmax.com',
       password: 'GlobalAdmin@1',
       avatar: 'MM',
       blocked: false,
       company: null,
       department: null,
       ...
       joinDate: '2026-01-01',
       phone: '081 815 8294',
       companyEmail: 'malope.mahlangu@workmax.co.za',
       personalEmail: 'malope.mahlangu@rm-tech.site',
     },
     {
       id: 'u2',
       role: 'company_admin',
       name: 'Malope Mothiba',
       email: 'admin@rmtech.com',
       password: 'R&MAdmin@01',
       avatar: 'MR',
       blocked: false,
       company: 'c1',
       ...
       joinDate: '2026-01-01',
       phone: '071 456 5443',
       companyEmail: 'malope@rmtech.com',
       personalEmail: 'malope.personal@gmail.com',
     },
     {
       id: 'u3',
       role: 'company_admin',
       name: 'Tshepho Tladi',
       email: 'admin@mtlaccountants.com',
       password: 'MTLAdmin@1',
       avatar: 'TT',
       blocked: false,
       company: 'c2',
       ...
       position: 'CEO',
       joinDate: '2026-07-01',
       phone: '+27 67 256 2160',
       companyEmail: 'tshepho@mtlaccountants.com',
       personalEmail: 'tshepho.tladi@gmail.com',
     },
   ],
 ...
 const checkDeviceLocation = (officeLat, officeLng, radiusMeters = 200) =>
   new Promise((resolve) => {
     if (officeLat == null || officeLng == null)
       return resolve({ status: 'no_office', distance: null });
     if (!navigator.geolocation)
       return resolve({ status: 'unavailable', distance: null });
   ...
   return (
     <div
       style={{
         ...
         zIndex: 9999,
         background: T.navyMid,
         border: `1px solid ${colors[type] || T.accent}`,
         borderLeft: `4px solid ${colors[type] || T.accent}`,
         borderRadius: 12,
         padding: '14px 20px',
         minWidth: 280,
     ...
     >
       <span style={{ color: colors[type] || T.accent, fontSize: 18 }}>
 ...
 function FaceScanner({ onApproved, onDenied, registeredDescriptor }) {
   ...
   useEffect(() => {
     ...
     Promise.all([
       ...
       .catch(() => {
         setPhase('error');
         setLoadStatus('Failed to load AI models. Check internet.');
       });
     return () => {
   ...
   const glowColor =
     phase === 'approved' ? T.success : phase === 'denied' ? T.danger : T.accent;
     ...
     >
       ...
       >
         <video
           ...
           style={{
             ...
             objectFit: 'cover',
             display:
               phase === 'camera' || phase === 'scanning' ? 'block' : 'none',
           }}
         />
         {phase !== 'camera' && phase !== 'scanning' && (
           <div
       ...
       {phase === 'loading' && (
         <div style={{ ...s.flex(8, 'row', 'center') }}>
           ...
           />
           <span style={{ ...s.sub, fontSize: 12 }}>{loadStatus}</span>
         </div>
       )}
       {phase === 'error' && (
         <p
       ...
       {phase === 'camera' && (
         <button
           ...
           style={{
             ...
             fontSize: 15,
             borderRadius: 12,
             boxShadow: `0 4px 16px ${T.success}44`,
           }}
         >
           <Icon.Check />
           Scan My Face
 ...
 function FaceCapture({ onCapture, onClear }) {
   ...
   const openCamera = async () => {
     ...
     try {
       ...
       setCamErr(
         'Camera access denied. Please allow camera or upload a photo instead.'
       );
     }
   };
   ...
   const handleUpload = (e) => {
     ...
     if (
       ...
       setCamErr('Only JPG, PNG or WEBP accepted.');
       return;
     }
     if (file.size > 5 * 1024 * 1024) {
       setCamErr('Image must be under 5 MB.');
       return;
     }
     ...
     >
         ...
         <>
           ...
           >
             ...
             <button
               ...
               style={{
                 ...s.btn('rgba(255,255,255,0.08)', T.white),
                 fontSize: 13,
                 padding: '9px 18px',
                 borderRadius: 10,
               }}
           ...
           <p style={{ fontSize: 11, color: T.gray400 }}>
           ...
           />
           {camErr && (
             <p style={{ fontSize: 12, color: T.danger, marginTop: 10 }}>
               {camErr}
             </p>
           )}
         </>
           ...
           <div style={{ ...s.flex(10, 'row', 'center') }}>
             <button
               ...
               style={{
                 ...
                 padding: '9px 20px',
                 borderRadius: 10,
                 boxShadow: `0 4px 12px ${T.success}44`,
               }}
             >
               <Icon.Camera />
               Take Photo
             ...
             <button
               ...
               style={{
                 ...s.btn('rgba(255,255,255,0.07)', T.gray400),
                 fontSize: 13,
                 padding: '9px 16px',
                 borderRadius: 10,
               }}
       ...
       {mode === 'preview' && preview && (
         ...
         >
           <div style={{ position: 'relative', display: 'inline-block' }}>
             <img
               ...
               style={{
                 ...
                 boxShadow: `0 0 20px ${T.success}44`,
               }}
             />
             <div
               style={{
           ...
           <p style={{ fontSize: 13, fontWeight: 700, color: T.success }}>
             ✓ Face image captured
           </p>
           <p style={{ ...s.sub, fontSize: 11 }}>
             Used for facial recognition during check-in.
           </p>
           <div style={{ ...s.flex(8, 'row', 'center') }}>
             <button
               onClick={() => {
               ...
               style={s.btnSm('rgba(255,255,255,0.07)', T.gray400)}
             >
               Retake
             </button>
             <button
 ...
 function LoginScreen({ onLogin }) {
   ...
   return (
     ...
     >
       ...
       <div
         style={{ width: '100%', maxWidth: 420, animation: 'fadeIn 0.5s ease' }}
       >
         {/* Brand */}
 ...
 function AppShell({
   ...
   return (
     <div style={{ display: 'flex', minHeight: '100vh', background: T.navy }}>
       ...
       >
         ...
         >
           <div style={{ ...s.flex(10, 'row', 'center') }}>
             ...
             <div>
               <div
                 style={{ fontWeight: 800, fontSize: 16, letterSpacing: -0.5 }}
               >
                 WorkMax
               </div>
         ...
         <nav style={{ flex: 1, padding: '16px 12px', overflowY: 'auto' }}>
           {navItems.map((item) => {
             ...
             return (
               ...
               >
                 <span style={{ color: active ? T.accentLight : T.gray400 }}>
                   {item.icon}
                 </span>
                 {item.label}
               </button>
       ...
       <div
         style={{
           marginLeft: isDesktop && sidebarOpen ? 240 : 0,
           flex: 1,
           display: 'flex',
           flexDirection: 'column',
         ...
         >
               ...
               {profileOpen && (
                 ...
                 >
                   {[
                     ...
                     >
                       <span style={{ color: T.gray400 }}>{item.icon}</span>
                       {item.label}
                     </button>
                   ))}
                   <div
           ...
           {user.role !== 'employee' && (
             <button
               onClick={onLogout}
               style={{
                 ...s.btn('rgba(255,255,255,0.06)', T.gray400),
                 fontSize: 13,
               }}
             >
               <Icon.Logout />
     ...
     <div style={{ ...s.card, flex: 1 }}>
       <div style={{ ...s.flex(12, 'row', 'flex-start') }}>
         ...
         <div>
           ...
           {sub && (
             <div style={{ ...s.sub, fontSize: 12, marginTop: 2 }}>{sub}</div>
           )}
         </div>
       </div>
     </div>
 ...
 function EmployeeDashboard({ user, data, setData, toast }) {
   ...
   const getAttendance = (dateStr) =>
     data.attendance.find((a) => a.userId === user.id && a.date === dateStr);
 
   // Auto-check location the moment the modal opens
   useEffect(() => {
     if (!dayModal) return;
     setLocationStatus('checking');
     setLocationMetres(null);
     const company = data.companies.find((c) => c.id === user.company);
     checkDeviceLocation(
       company?.lat ?? null,
       company?.lng ?? null,
       company?.checkinRadius ?? 150
   ...
   const doCheckIn = async () => {
     if (!faceOk) return;
     const locPassed =
       locationStatus === 'approved' || locationStatus === 'no_office';
     if (!locPassed) return;
     ...
     const rec = {
       ...
       checkOut: null,
       status: 'present',
       locationVerified: locationStatus === 'approved',
     };
     await createAttendanceInDB(rec, user.company); // saves to Supabase
   ...
   return (
     <div className="fade-in">
       ...
       >
         <StatCard
           label="Status Today"
           value={todayAtt ? 'Present' : 'Absent'}
           color={todayAtt ? T.success : T.danger}
           icon={<Icon.Check />}
           sub={todayAtt ? `In: ${todayAtt.checkIn}` : 'Not checked in'}
         />
         <StatCard
           label="This Month"
           value={
         ...
         <StatCard
           ...
           value={
             data.leaves.filter(
               (l) => l.userId === user.id && l.status === 'pending'
             ).length
           }
           color={T.warning}
           icon={<Icon.Leave />}
       ...
       <div style={{ ...s.card, padding: 8 }}>
         ...
         >
           <button
             ...
             style={s.btnSm('rgba(255,255,255,0.07)', T.white)}
           >
             ‹
           </button>
           <span style={{ ...s.h3, fontSize: 18 }}>
         ...
         >
           ...
           {Array(days)
             ...
             .map((_, i) => {
               ...
               } else if (att?.status === 'absent' && isPast && !isWeekend) {
                 bg = `${T.danger}22`;
         ...
         >
           {[
             ...
             <div key={l} style={{ ...s.flex(6, 'row', 'center') }}>
               ...
               />
               <span style={{ ...s.sub, fontSize: 12 }}>{l}</span>
             </div>
           ))}
         </div>
       </div>
       ...
       {dayModal && (
         <Modal
           title={`Check-In — ${fmtDate(dayModal)}`}
           ...
           {todayAtt ? (
             <div style={{ textAlign: 'center', padding: '16px 0' }}>
               ...
               <p style={{ ...s.sub, marginTop: 8 }}>
                 Check-in: {todayAtt.checkIn} · Auto checkout: 16:00
               </p>
             </div>
           ) : (
             <>
               ...
               {isBeforeCutoff && (
                 <>
                     ...
                     >
                       ...
                       <div style={{ flex: 1 }}>
                         ...
                         <div style={{ ...s.sub, fontSize: 11, marginTop: 2 }}>
                           ...
                           {locationStatus === 'approved' &&
                             `✓ Within office radius (${locationMetres}m away${
                               locationAccuracy != null
                                 ? `, GPS ±${locationAccuracy}m`
                                 : ''
                             })`}
                           {locationStatus === 'out_of_range' &&
                             `✕ ${locationMetres}m from office — need to be within ${
                               data.companies.find((c) => c.id === user.company)
                                 ?.checkinRadius || 150
                             }m`}
                           ...
                           {locationStatus === 'no_office' &&
                             '⚠ No office coordinates configured — location check skipped'}
                         </div>
                       </div>
                     </div>
                     ...
                     <div style={{ ...s.flex(10, 'row', 'center') }}>
                       <div
                         style={{
                           ...
                           background: faceOk
                             ? `${T.success}22`
                             : 'rgba(255,255,255,0.06)',
                           color: faceOk ? T.success : T.gray400,
                         }}
                       >
                         {faceOk ? '✓' : '…'}
                       </div>
                       <div style={{ flex: 1 }}>
                         ...
                         <div style={{ ...s.sub, fontSize: 11, marginTop: 2 }}>
                           {faceOk
                             ? '✓ Identity verified'
                             : 'Pending — complete face scan below'}
                         </div>
                       </div>
                     </div>
                   </div>
                   ...
                   {(() => {
                     ...
                     const label = checkDone
                       ? '✓ Checked In'
                       : !faceOk && !locPassed
                       ? 'Face scan + location required'
                       : !faceOk
                       ? 'Face scan required'
                       : !locPassed
                     ...
                     return (
                       <button
                         ...
                         style={{
                           ...
                           borderRadius: 12,
                           cursor:
                             allPassed && !checkDone ? 'pointer' : 'not-allowed',
                           opacity: allPassed && !checkDone ? 1 : 0.45,
                         }}
                       >
                         {checkDone ? (
                           label
 ...
 function EmployeeLeave({ user, data, setData, toast }) {
   ...
   return (
     <div className="fade-in">
       ...
       >
         <div>
           <h2 style={s.h2}>Leave Management</h2>
           ...
           >
             <div style={{ flex: 1, minWidth: 200 }}>
               <div style={{ ...s.flex(10, 'row', 'center'), marginBottom: 8 }}>
                 ...
                 <span style={s.badge(statusColor[l.status] || T.gray400)}>
             ...
             {l.adminComment && (
               ...
               >
                 <p style={{ ...s.sub, fontSize: 12, marginBottom: 4 }}>
                   Admin Comment
                 </p>
       ...
       {showForm && (
         <Modal title="Apply for Leave" onClose={() => setShowForm(false)}>
           <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
             ...
             <div
               style={{
                 ...s.flex(12, 'row', 'center'),
                 justifyContent: 'flex-end',
               }}
             >
               <button
                 onClick={() => setShowForm(false)}
                 style={s.btn('rgba(255,255,255,0.07)', T.white)}
               >
                 Cancel
               </button>
               <button
 ...
 function EmployeePayslips({ user, data, setData, toast }) {
   ...
   const mySlips = data.payslips
     .filter((p) => p.userId === user.id && p.year === currentYear)
   ...
   const buildPDF = (slip) => {
     ...
     doc.setTextColor(255, 255, 255);
     doc.setFontSize(10);
     doc.text(`${slip.month.toUpperCase()} ${slip.year}`, pw - 15, 27, {
       align: 'right',
     });
     doc.setFontSize(8);
     doc.setFont('helvetica', 'bold');
     ...
     doc.setDrawColor(226, 232, 240);
     doc.line(15, 145, pw - 15, 145);
     doc.setFont('helvetica', 'bold');
     doc.setFontSize(9);
     doc.setTextColor(71, 85, 105);
     doc.text('Gross Pay', 20, 153);
     doc.setTextColor(16, 185, 129);
     doc.text(
       `R${(slip.basicSalary + slip.allowances).toFixed(2)}`,
       pw - 15,
       153,
       { align: 'right' }
     );
     ...
     doc.setFontSize(8);
     doc.setTextColor(100, 116, 139);
     doc.text('DEDUCTIONS', 15, 164);
     doc.line(15, 167, pw - 15, 167);
     doc.setFont('helvetica', 'normal');
     doc.setFontSize(9);
     doc.setTextColor(71, 85, 105);
     doc.text('Total Deductions', 20, 176);
     doc.setFont('helvetica', 'bold');
     doc.setTextColor(239, 68, 68);
     doc.text(`-R${slip.deductions.toFixed(2)}`, pw - 15, 176, {
       align: 'right',
     });
     doc.setFillColor(18, 41, 84);
     doc.roundedRect(15, 186, pw - 30, 24, 3, 3, 'F');
     doc.setFont('helvetica', 'normal');
     doc.setFontSize(9);
     doc.setTextColor(148, 163, 184);
     doc.text('NET PAY', 23, 197);
     doc.text('(Basic + Allowances - Deductions)', 23, 204);
     doc.setFont('helvetica', 'bold');
     doc.setFontSize(18);
     doc.setTextColor(16, 185, 129);
     doc.text(`R${slip.netPay.toFixed(2)}`, pw - 23, 201, { align: 'right' });
     doc.setDrawColor(226, 232, 240);
     doc.line(15, 218, pw - 15, 218);
     doc.setFontSize(7);
     doc.setFont('helvetica', 'normal');
     doc.setTextColor(148, 163, 184);
     doc.text(
     ...
     doc.text(
       `Generated by WorkMax · Powered by RM TECH · ${new Date().toLocaleDateString(
         'en-US',
         { dateStyle: 'long' }
       )}`,
       pw / 2,
   ...
   const downloadSlip = (slip) => {
     ...
     setData((d) => ({
       ...d,
       payslips: d.payslips.map((p) =>
         p.id === slip.id ? { ...p, downloaded: true } : p
       ),
     }));
  ...
  Powered by WorkMax · RM TECH`
     ...
     setEmailModal(null);
     toast(
       `PDF downloaded. Email client opened for ${emailAddress}!`,
       'success'
     );
   };
   ...
   return (
     <div className="fade-in">
       ...
       {mySlips.length === 0 ? (
         ...
         >
           No payslips available for {currentYear}.
         </div>
       ) : (
         <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
           {mySlips.map((slip) => (
             ...
             >
               ...
               <div style={{ flex: 1 }}>
                 <div style={{ ...s.h3, marginBottom: 4 }}>
                   {slip.month} {slip.year}
                 </div>
                 <p style={{ ...s.sub, fontSize: 13 }}>
                   Issued: {fmtDate(slip.issueDate)}
                 </p>
               </div>
               <div style={{ ...s.flex(24, 'row', 'center'), flexWrap: 'wrap' }}>
                 {[
                   ...
                   <div key={l} style={{ textAlign: 'center' }}>
                     <div style={{ ...s.sub, fontSize: 11, marginBottom: 2 }}>
                       {l}
                     </div>
                 ...
                 <div style={{ textAlign: 'center' }}>
                   ...
                   <div
                     style={{ fontSize: 18, fontWeight: 800, color: T.success }}
                   >
                     R{slip.netPay.toFixed(2)}
                   </div>
                 </div>
               </div>
               ...
               <div style={{ ...s.flex(8, 'row', 'center'), flexShrink: 0 }}>
                 <button
                   ...
                   style={s.btn(T.success)}
                 >
                   <Icon.Download />
                   Download
                 </button>
                 <button
                   onClick={() => openEmailModal(slip)}
       ...
       {emailModal && (
         <Modal
           title={`Email Payslip — ${emailModal.month} ${emailModal.year}`}
         ...
         >
           <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
             ...
             >
               ...
               >
                 The PDF will be{' '}
                 <strong style={{ color: T.accentLight }}>
                   downloaded to your device
                 </strong>{' '}
                 and your default email app will open with a pre-filled summary.
             ...
             <div>
               ...
               >
                 {user.personalEmail && (
                   <button
                     onClick={() => setEmailAddress(user.personalEmail)}
                     style={s.btnSm('rgba(255,255,255,0.07)', T.gray400)}
                   >
                 ...
                 {user.companyEmail && (
                   <button
                     onClick={() => setEmailAddress(user.companyEmail)}
                     style={s.btnSm('rgba(255,255,255,0.07)', T.gray400)}
                   >
                     Work: {user.companyEmail}
                   </button>
                 )}
               </div>
             </div>
 ...
 function EmployeeProfile({ user, data, setData, toast }) {
   ...
   const changePassword = () => {
     ...
     setData((d) => ({
       ...d,
       users: d.users.map((u2) =>
         u2.id === user.id ? { ...u2, password: pwForm.new1 } : u2
       ),
     }));
   ...
   const savePersonalEmail = async () => {
     try {
       ...
       setData((d) => ({
         ...d,
         users: d.users.map((u2) =>
           u2.id === user.id ? { ...u2, personalEmail: personalEmailVal } : u2
         ),
       }));
     ...
     <div className="fade-in">
       ...
       <div style={{ ...s.flex(4, 'row', 'center'), marginBottom: 20 }}>
         {[
           ...
           <button
             ...
             style={{
               ...s.btnSm(
                 tab === id ? T.accent : 'rgba(255,255,255,0.06)',
                 tab === id ? T.white : T.gray400
               ),
               padding: '8px 18px',
             }}
           >
         ...
         <div style={{ ...s.card }}>
           ...
           >
             {[
               ...
               [
                 'Company',
                 data.companies.find((c) => c.id === user.company)?.name || '—',
               ],
               ['Join Date', fmtDate(user.joinDate)],
               ...
               {editPersonalEmail ? (
                 <div style={{ ...s.flex(6, 'row', 'center') }}>
                   ...
                   <button
                     ...
                     style={s.btnSm(T.success)}
                   >
                     <Icon.Check />
                   </button>
                   <button
                     onClick={() => setEditPersonalEmail(false)}
                     style={s.btnSm('rgba(255,255,255,0.07)', T.gray400)}
                   >
                     <Icon.X />
                   </button>
                 ...
                 <div style={{ ...s.flex(8, 'row', 'center') }}>
                   ...
                   <button
                     onClick={() => {
                       setPersonalEmailVal(user.personalEmail || '');
                       setEditPersonalEmail(true);
                     }}
                     style={s.btnSm('rgba(255,255,255,0.07)', T.gray400)}
                   >
                     Edit
       ...
       {tab === 'password' && (
         <div style={{ ...s.card, maxWidth: 480 }}>
           ...
           <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
             {[
               ['old', 'Current Password', 'Enter your current password'],
               ['new1', 'New Password', 'Minimum 8 characters'],
               ['new2', 'Confirm New Password', 'Re-enter new password'],
     ...
     <div className="fade-in">
       ...
       >
         <StatCard
           ...
           value={`${rate}%`}
           color={rate > 90 ? T.success : T.warning}
           icon={<Icon.Stats />}
         />
         <StatCard
           label="Days Present"
 ...
 function AdminEmployees({ user, data, setData, toast }) {
   ...
   const employees = data.users.filter(
     (u) => u.role === 'employee' && u.company === user.company
   );
 
   const addEmployee = async () => {
     if (!form.name || !form.email || !form.password) {
       toast('Name, login email and password required.', 'error');
       return;
     }
     if (data.users.find((u) => u.email === form.email)) {
       toast('Login email already exists.', 'error');
       return;
     }
     const newEmp = {
       id: genId(),
           ...
           <tbody>
             {employees.map((emp, i) => (
               ...
               >
                 <td style={{ padding: '12px 14px' }}>
                   <div style={{ ...s.flex(10, 'row', 'center') }}>
                     ...
                     <div>
                       ...
                       <div style={{ ...s.sub, fontSize: 12 }}>{emp.email}</div>
                     </div>
                   </div>
                 </td>
                 <td
                 ...
                 <td style={{ padding: '12px 14px' }}>
                   <span
                     style={s.badge(emp.faceRegistered ? T.success : T.warning)}
                   >
                     {emp.faceRegistered ? 'Registered' : 'Pending'}
                   </span>
                 </td>
                 <td style={{ padding: '12px 14px' }}>
                   <span style={s.badge(emp.blocked ? T.danger : T.success)}>
                 ...
                 <td style={{ padding: '12px 14px' }}>
                   <div style={{ ...s.flex(8) }}>
                     ...
                     <button
                       ...
                       style={s.btnSm(`${T.danger}22`, T.danger)}
                     >
                       <Icon.Trash />
                     </button>
                   </div>
             ...
             {employees.length === 0 && (
               <tr>
                 <td
                   colSpan={6}
                   style={{ padding: 32, textAlign: 'center', color: T.gray400 }}
                 >
                   No employees yet.
                 </td>
               </tr>
         ...
         <Modal title="Employee Details" onClose={() => setViewEmp(null)}>
           <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
             <div style={{ ...s.flex(14, 'row', 'center'), padding: '4px 0' }}>
               ...
               <div>
                 <div style={s.h2}>{viewEmp.name}</div>
                 <div style={{ ...s.sub, marginTop: 4 }}>{viewEmp.email}</div>
               </div>
             </div>
             {[
               ['Company Email', viewEmp.companyEmail || '—'],
               ['Personal Email', viewEmp.personalEmail || '—'],
               ['Department', viewEmp.department],
               ['Position', viewEmp.position],
               ['Phone', viewEmp.phone],
               ['Join Date', fmtDate(viewEmp.joinDate)],
               [
                 'Face ID',
                 viewEmp.faceRegistered ? 'Registered' : 'Not Registered',
               ],
               ['Status', viewEmp.blocked ? 'Blocked' : 'Active'],
             ].map(([l, v]) => (
               <div
                 key={l}
                 style={{
 ...
 function AdminLeave({ user, data, setData, toast }) {
   ...
   const companyEmpIds = data.users
     .filter((u) => u.role === 'employee' && u.company === user.company)
     .map((u) => u.id);
   ...
   const leavesByEmployee = companyEmpIds.reduce((acc, empId) => {
     const empLeaves = allLeaves
       .filter((l) => l.userId === empId)
       .sort((a, b) => b.startDate.localeCompare(a.startDate));
     if (empLeaves.length > 0)
       acc.push({ emp: getEmp(empId), leaves: empLeaves });
     return acc;
   }, []);
           ...
           return (
             <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
               <div style={{ ...s.card, background: 'rgba(255,255,255,0.03)' }}>
                 {[
                   ['Employee', emp?.name],
                   ['Leave Type', reviewModal.type],
                   [
                     'Duration',
                     `${fmtDate(reviewModal.startDate)} → ${fmtDate(
                       reviewModal.endDate
                     )}`,
                   ],
                 ].map(([l, v]) => (
               ...
               >
                 ...
                 <button
                   ...
                   style={s.btn(`${T.danger}22`, T.danger)}
                 >
                   <Icon.X />
                   Deny
                 </button>
       ...
       >
         ...
         <div style={{ ...s.flex(4, 'row', 'center') }}>
           <button
             ...
             style={s.btnSm(
               viewMode === 'byEmployee' ? T.accent : 'rgba(255,255,255,0.07)',
               viewMode === 'byEmployee' ? T.white : T.gray400
             )}
           >
             By Employee
           </button>
           <button
             ...
             style={s.btnSm(
               viewMode === 'table' ? T.accent : 'rgba(255,255,255,0.07)',
               viewMode === 'table' ? T.white : T.gray400
             )}
           >
             Table View
           </button>
           ...
           {leavesByEmployee.map(({ emp, leaves }) => (
             <div key={emp?.id || 'unknown'} style={s.card}>
               ...
               >
                 ...
                 <div style={{ ...s.flex(6, 'row', 'center') }}>
                   <span style={s.badge(T.warning)}>
                     {leaves.filter((l) => l.status === 'pending').length}{' '}
                     pending
                   </span>
                   <span style={s.badge(T.success)}>
                 ...
                 {leaves.map((l) => (
                   ...
                   >
                     <div style={{ flex: 1, minWidth: 160 }}>
                       ...
                       <div style={{ ...s.sub, fontSize: 12, marginTop: 2 }}>
                         {fmtDate(l.startDate)} – {fmtDate(l.endDate)}
                       </div>
                     </div>
                     <div
                     ...
                     {l.status === 'pending' ? (
                       ...
                       >
                         {l.adminComment ? 'Commented' : 'Reviewed'}
                       </span>
                     )}
                   </div>
                 ))}
                 ...
                 .map((l, i) => {
                   ...
                   return (
                     ...
                     >
                       ...
                       <td style={{ padding: '12px 14px' }}>
                         <span
                           style={s.badge(statusColor[l.status] || T.gray400)}
                         >
                           {l.status.toUpperCase()}
                         </span>
                       </td>
 ...
 function AdminPayslips({ user, data, setData, toast }) {
   ...
   const companyEmpIds = data.users
     .filter((u) => u.role === 'employee' && u.company === user.company)
     .map((u) => u.id);
   const allSlips = data.payslips.filter((p) =>
     companyEmpIds.includes(p.userId)
   );
   const getEmp = (id) => data.users.find((u) => u.id === id);
   const months = [
     'January',
     ...
     <div className="fade-in">
       ...
       >
         <div>
           ...
           <p style={{ ...s.sub, marginTop: 4 }}>
             Manage employee payslip records
           </p>
         </div>
         <button
           onClick={() => {
       ...
       {showAdd && (
         <Modal
           title={editSlip ? 'Edit Payslip' : 'New Payslip'}
           onClose={() => {
             setShowAdd(false);
             setEditSlip(null);
           }}
         >
           <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
             ...
             >
               ...
               <div>
                 <label style={s.label}>Basic Salary (R)</label>
                 <input
                   type="number"
               ...
               <div>
                 <label style={s.label}>Allowances (R)</label>
                 <input
                   type="number"
               ...
               <div>
                 <label style={s.label}>Deductions (R)</label>
                 <input
                   type="number"
               ...
               >
                 ...
                 <div
                   style={{ fontSize: 20, fontWeight: 800, color: T.success }}
                 >
                   R
                   {(
                     (+form.basicSalary || 0) +
 ...
 function AdminStats({ user, data }) {
   ...
   const relevantAtt = data.attendance.filter((a) =>
     selectedEmp === 'all'
       ? companyEmpIds.includes(a.userId)
       : a.userId === selectedEmp
   );
   ...
   return (
     <div className="fade-in">
       ...
       >
         <div>
           <h2 style={s.h2}>Attendance Statistics</h2>
           <p style={{ ...s.sub, marginTop: 4 }}>
       ...
       >
         <StatCard
           ...
           icon={<Icon.Check />}
           sub={
             total ? `${Math.round((present / total) * 100)}% of records` : ''
           }
         />
         <StatCard
           label="Late"
           ...
           color={T.warning}
           icon={<Icon.Clock />}
           sub={total ? `${Math.round((late / total) * 100)}% of records` : ''}
         />
         <StatCard
           label="Absent"
           value={absent}
           color={T.danger}
           icon={<Icon.X />}
           sub={total ? `${Math.round((absent / total) * 100)}% of records` : ''}
         />
         <StatCard
           label="Total"
           value={total}
       ...
       {selectedEmp === 'all' && (
         <div style={s.card}>
           ...
           <table style={{ width: '100%', borderCollapse: 'collapse' }}>
             <thead>
               <tr>
                 {['Employee', 'Present', 'Late', 'Absent', 'Rate'].map((h) => (
                   <th
                     key={h}
                     style={{
                       textAlign: 'left',
             ...
             <tbody>
               {employees.map((emp, i) => {
                 ...
                 const ep = ea.filter((a) => a.status === 'present').length,
                   el = ea.filter((a) => a.status === 'late').length,
                   eab = ea.filter((a) => a.status === 'absent').length;
                 const et = ep + el + eab,
                   rate = et ? Math.round((ep / et) * 100) : 0;
                 return (
                   <tr
                     key={emp.id}
                     style={{
       ...
       {selectedEmp !== 'all' && (
         <div style={s.card}>
           <h3 style={{ ...s.h3, marginBottom: 16 }}>
             Attendance Log —{' '}
             {data.users.find((u) => u.id === selectedEmp)?.name}
           </h3>
           <table style={{ width: '100%', borderCollapse: 'collapse' }}>
             <thead>
               <tr>
 ...
 function AdminPassword({ user, data, setData, toast }) {
   ...
   const submit = async () => {
     const u = data.users.find((u2) => u2.id === user.id);
     if (form.old !== u.password) {
       toast('Current password incorrect.', 'error');
       return;
     }
     if (form.new1.length < 8) {
       toast('New password must be ≥ 8 characters.', 'error');
       return;
     }
     ...
     try {
       ...
       setData((d) => ({
         ...d,
         users: d.users.map((u2) =>
           u2.id === user.id ? { ...u2, password: form.new1 } : u2
         ),
       }));
 ...
 function GlobalAdminManage({ data, setData, toast }) {
   ...
   const addAdmin = async () => {
     if (!form.name || !form.email || !form.password) {
       toast('Admin name, email and password required.', 'error');
       return;
     }
     ...
     if (form.officeLat === '' || form.officeLng === '') {
       toast('Office latitude and longitude are required.', 'error');
       return;
     }
     if (data.users.find((u) => u.email === form.email)) {
     ...
     const lat = parseFloat(form.officeLat),
       lng = parseFloat(form.officeLng),
       radius = parseInt(form.checkinRadius) || 200;
     ...
     try {
       ...
       setData((d) => ({
         ...d,
         companies: [...d.companies, newCompany],
         users: [...d.users, newAdmin],
       }));
       toast(
         `Admin "${form.name}" and company "${form.companyName}" created!`,
         'success'
       );
       setShowAdd(false);
       setForm({
   ...
   const toggleBlock = async (u) => {
     try {
       ...
       setData((d) => ({
         ...d,
         users: d.users.map((u2) =>
           u2.id === u.id ? { ...u2, blocked: !u2.blocked } : u2
         ),
       }));
       toast(
         u.blocked ? `${u.name} unblocked.` : `${u.name} blocked.`,
         u.blocked ? 'success' : 'error'
       );
     } catch (err) {
       toast(`Error: ${err.message}`, 'error');
     }
   ...
   return (
     <div className="fade-in">
       ...
       >
         <div>
           <h2 style={s.h2}>Company Admins</h2>
           <p style={{ ...s.sub, marginTop: 4 }}>
             {admins.length} admin(s) · {data.companies.length} companies
           </p>
         </div>
         <button
           onClick={() => setShowAdd(true)}
             ...
             {admins.map((a, i) => {
               ...
               return (
                 ...
                 >
                   ...
                   >
                     {co?.lat != null ? (
                       <span style={{ ...s.flex(4, 'row', 'center') }}>
                         <Icon.Pin />
                   ...
                   <td style={{ padding: '12px 14px' }}>
                     <span style={s.badge(a.blocked ? T.danger : T.success)}>
                   ...
                   <td style={{ padding: '12px 14px' }}>
                     <div style={{ ...s.flex(8) }}>
                       <button
                         ...
                         style={s.btnSm(
                           a.blocked ? `${T.success}22` : `${T.warning}22`,
                           a.blocked ? T.success : T.warning
                         )}
                       >
       ...
       {showAdd && (
         <Modal
           title="Add Company Admin + Company"
         ...
         >
           <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
             ...
             >
               ...
               <div>
                 ...
                 <input
                   ...
                   onChange={(e) =>
                     setForm((f) => ({ ...f, companyIndustry: e.target.value }))
                   }
                   style={s.input}
             ...
             >
               ...
               >
                 📍 Office Location for Check-in Verification
               </p>
               <p style={{ fontSize: 11, color: T.gray400, marginBottom: 14 }}>
                 Employees must be within the specified radius to check in. Get
                 coordinates by right-clicking the office location on Google
                 Maps.
               </p>
               <div
                 style={{
               ...
               >
                 <div>
                   ...
                   <input
                     ...
                     onChange={(e) =>
                       setForm((f) => ({ ...f, officeLat: e.target.value }))
                     }
                     style={s.input}
                     type="number"
                     step="0.0001"
                 ...
                 <div>
                   ...
                   <input
                     ...
                     onChange={(e) =>
                       setForm((f) => ({ ...f, officeLng: e.target.value }))
                     }
                     style={s.input}
                     type="number"
                     step="0.0001"
               ...
               {form.officeLat && form.officeLng && (
                 <p
                   style={{ fontSize: 11, color: T.accentLight, marginTop: 10 }}
                 >
                   ↗ Coordinates: {parseFloat(form.officeLat).toFixed(5)},{' '}
                   {parseFloat(form.officeLng).toFixed(5)} ·{' '}
                   {form.checkinRadius || 200}m radius
                 </p>
               )}
             </div>
             <div
 ...
 function GlobalAdminUsers({ data, setData, toast }) {
   ...
   const users = data.users.filter(
     (u) => u.role !== 'global_admin' && (filter === 'all' || u.role === filter)
   );
   const toggleBlock = (u) => {
     setData((d) => ({
       ...d,
     ...
     <div className="fade-in">
       ...
       >
         <div>
           ...
           <p style={{ ...s.sub, marginTop: 4 }}>{users.length} users</p>
         </div>
         <div style={{ ...s.flex(4) }}>
           {[
             ['all', 'All'],
             ...
             <button
               ...
               onClick={() => setFilter(v)}
               style={s.btnSm(
                 filter === v ? T.accent : 'rgba(255,255,255,0.07)',
                 filter === v ? T.white : T.gray400
               )}
             >
               {l}
             </button>
           ...
           <tbody>
             {users.map((u, i) => (
               ...
               >
                 <td style={{ padding: '12px 14px' }}>
                   <div style={{ ...s.flex(10, 'row', 'center') }}>
                     ...
                     <div>
                       ...
                       <div style={{ ...s.sub, fontSize: 11 }}>{u.email}</div>
                     </div>
                   </div>
                 </td>
                 <td style={{ padding: '12px 14px' }}>
                   <span
                     style={s.badge(
                       u.role === 'company_admin' ? T.accent : T.accentLight
                     )}
                   >
                 ...
                 <td style={{ padding: '12px 14px', fontSize: 13 }}>
                   {data.companies.find((c) => c.id === u.company)?.name || '—'}
                 </td>
                 <td
                   style={{
                     padding: '12px 14px',
                 ...
                 <td style={{ padding: '12px 14px' }}>
                   <span style={s.badge(u.blocked ? T.danger : T.success)}>
                 ...
                 <td style={{ padding: '12px 14px' }}>
                   <button
                     ...
                     style={s.btnSm(
                       u.blocked ? `${T.success}22` : `${T.warning}22`,
                       u.blocked ? T.success : T.warning
                     )}
                   >
 ...
 function GlobalAdminDashboard({ data }) {
   const totalAdmins = data.users.filter(
           ...
           >
             <div style={{ ...s.flex(12, 'row', 'center') }}>
               ...
               <div>
                 ...
                 {c.lat != null && (
                   ...
                   >
                     <Icon.Pin /> {c.lat.toFixed(4)}, {c.lng.toFixed(4)} ·{' '}
                     {c.checkinRadius}m radius
                   </div>
                 )}
               </div>
             </div>
             <div style={{ textAlign: 'right' }}>
               <div style={{ fontWeight: 700 }}>
                 {
                   data.users.filter(
                     (u) => u.company === c.id && u.role === 'employee'
                   ).length
                 }{' '}
                 employees
               </div>
               <div style={{ ...s.sub, fontSize: 12 }}>
                 {
                   data.users.filter(
                     (u) => u.company === c.id && u.role === 'company_admin'
                   ).length
                 }{' '}
                 admins
               </div>
 ...
 export default function WorkMaxApp() {
   ...
   const handleLogin = useCallback(async (user) => {
     try {
       ...
       const [
         ...
         fetchAdmins(),
         fetchCompanies(),
         isGlobal ? fetchAllEmployees() : fetchEmployees(user.company),
   ...
   const renderView = () => {
     ...
     if (currentUser.role === 'employee')
       return (
         {
           dashboard: <EmployeeDashboard {...p} />,
           leave: <EmployeeLeave {...p} />,
           payslips: <EmployeePayslips {...p} />,
           profile: <EmployeeProfile {...p} />,
           stats: <EmployeeStats {...p} />,
         }[activeNav] || null
       );
     if (currentUser.role === 'company_admin')
       return (
         {
           employees: <AdminEmployees {...p} />,
           leave: <AdminLeave {...p} />,
           payslips: <AdminPayslips {...p} />,
           stats: <AdminStats {...p} />,
     ...
     if (currentUser.role === 'global_admin')
       return (
         {
           overview: <GlobalAdminDashboard {...p} />,
           admins: <GlobalAdminManage {...p} />,
           allusers: <GlobalAdminUsers {...p} />,
           password: <AdminPassword {...p} />,
         }[activeNav] || null
       );
   };
   ...
   return (
     <>
       <AppShell
         ...
         navItems={navConfigs[currentUser.role] || []}
       >
         {renderView()}
       </AppShell>
       {toast && (
